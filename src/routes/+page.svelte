<script lang="ts">
	import { Github, Linkedin, Twitter, ArrowDown } from '@lucide/svelte';
...
<svelte:head>
	<title>Kyle Mendell</title>
	<meta name="description" content="Web developer specializing in modern web applications" />
</svelte:head>
